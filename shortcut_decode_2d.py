...
plot_compare_decoded_track(actual, decode, str(round(np.mean(combined_errors), 2)), max_y=1.0, savepath=savepath)
...
plot_compare_decoded_track(normalized_actual, normalized_decoded, max_y=60., savepath=savepath)
