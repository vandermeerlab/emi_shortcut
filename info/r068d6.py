...
xedges = np.arange(42.22222222222222, 210.22222222222223+info.meta.binsize, info.meta.binsize)
yedges = np.arange(2.9629629629629632, 134.96296296296296+info.meta.binsize, info.meta.binsize)
...
task_times = dict()
task_times['prerecord'] = nept.Epoch([1622.5], [1923.8])
task_times['phase1'] = nept.Epoch([1959.6], [2450.2])
task_times['pauseA'] = nept.Epoch([2651.2], [3088.2])
task_times['phase2'] = nept.Epoch([3155.0], [4628.0])
task_times['pauseB'] = nept.Epoch([4657.3], [6482.2])
task_times['phase3'] = nept.Epoch([6524.4], [9276.9])
task_times['postrecord'] = nept.Epoch([9303.1], [9609.6])
...
problem_positions = nept.Epoch([2569.9, 2647.2, 9498.5], [2574.0, 2651.2, 9504.2])
