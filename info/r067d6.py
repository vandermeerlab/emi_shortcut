...
task_times = dict()
task_times['prerecord'] = nept.Epoch([901.0], [1202.9])
task_times['phase1'] = nept.Epoch([1252.5], [1760.8])
task_times['pauseA'] = nept.Epoch([1779.0], [2436.1])
task_times['phase2'] = nept.Epoch([2466.0], [3723.5])
task_times['pauseB'] = nept.Epoch([3723.5], [5603.2])
task_times['phase3'] = nept.Epoch([5636.8], [8385.6])
task_times['postrecord'] = nept.Epoch([8412.9], [8716.6])
